...
public interface SpawnPredictorConfig extends Config {
    ...
    @ConfigItem(
            ...
            description = "Color the overlay names inside the Fight Caves to it's respective color.<br>Example: Current Wave Color=White -> Name=White, Next Wave Color=Green -> Name=Green",
            position = 5
    )
