...
public class SocketPingOverlay extends Overlay {
    ...
    static {
        ...
        WARN_IMAGE = ImageUtil.loadImageResource(SocketPingOverlay.class, "warn.png");
        OMW_IMAGE = ImageUtil.loadImageResource(SocketPingOverlay.class, "omw.png");
        ASSIST_ME_IMAGE = ImageUtil.loadImageResource(SocketPingOverlay.class, "assistme.png");
        QUESTION_MARK_IMAGE = ImageUtil.loadImageResource(SocketPingOverlay.class, "questionmark.png");
    }

    @Inject
    SocketPingOverlay(SocketPing plugin, SocketPingConfig config) {
        this.plugin = plugin;
        this.config = config;
    ...
    public Dimension render(Graphics2D graphics) {
        ...
        if (isHotkeyPressed || (keyheld != null && (config

                .hotkeyOmw().matches(keyheld) || config
                .hotkeyQuestionMark().matches(keyheld) || config
                .hotkeyAssistMe().matches(keyheld) || config
                .hotkeyWarn().matches(keyheld)))) {
