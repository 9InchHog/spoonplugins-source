...
public class CustomClientResizingProfilePanel extends JPanel
{
    ...
    static
    {
        final BufferedImage visibleImg = ImageUtil.loadImageResource(CustomClientResizingPlugin.class, "visible_icon.png");
        VISIBLE_ICON = new ImageIcon(visibleImg);
        VISIBLE_HOVER_ICON = new ImageIcon(ImageUtil.alphaOffset(visibleImg, -100));

        final BufferedImage invisibleImg = ImageUtil.loadImageResource(CustomClientResizingPlugin.class, "invisible_icon.png");
        INVISIBLE_ICON = new ImageIcon(invisibleImg);
        INVISIBLE_HOVER_ICON = new ImageIcon(ImageUtil.alphaOffset(invisibleImg, -100));

        final BufferedImage deleteImg = ImageUtil.loadImageResource(CustomClientResizingPlugin.class, "delete_icon.png");
    ...
    private JPanel createPositionPanel(int width, int height)
    {
        ...
        widthSpinner.setToolTipText("Horizontal Position");
        heightSpinner.setToolTipText("Vertical Position");
    ...
    private JPanel createSizePanel(int width, int height)
    {
        ...
        widthSpinner.setToolTipText("Client Width");
        heightSpinner.setToolTipText("Client Height");
    ...
    {
        SpinnerModel model = new SpinnerNumberModel(value, -32000, 32000, 1);
