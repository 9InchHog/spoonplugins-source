...
class SocketWorldTableRow extends JPanel
{
    ...
    static
    {
        FLAG_AUS = new ImageIcon(ImageUtil.loadImageResource(SocketWorldHopperPlugin.class, "flag_aus.png"));
        FLAG_UK = new ImageIcon(ImageUtil.loadImageResource(SocketWorldHopperPlugin.class, "flag_uk.png"));
        FLAG_US = new ImageIcon(ImageUtil.loadImageResource(SocketWorldHopperPlugin.class, "flag_us.png"));
        FLAG_GER = new ImageIcon(ImageUtil.loadImageResource(SocketWorldHopperPlugin.class, "flag_ger.png"));
    }
    ...
    SocketWorldTableRow(World world, boolean current, boolean favorite, Integer ping, Consumer<World> onSelect, BiConsumer<World, Boolean> onFavorite)
    {
        this.world = world;
        ...
        addMouseListener(new MouseAdapter()
        {
            ...
            {
                SocketWorldTableRow.this.lastBackground = getBackground();
                setBackground(getBackground().brighter());
            }
