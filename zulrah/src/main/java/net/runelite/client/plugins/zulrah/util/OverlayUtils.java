...
public class OverlayUtils {
    ...
    public static void renderTextLocation(Graphics2D graphics, Point txtLoc, String text, Color color, Supplier<Boolean> outline) {
    ...
    public static void renderPolygon(Graphics2D graphics, Shape polygon, Color color, double outlineStroke, int fillAlpha) {
        if (polygon != null) {
