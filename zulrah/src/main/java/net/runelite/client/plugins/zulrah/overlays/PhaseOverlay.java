...
public class PhaseOverlay extends OverlayPanel {
    ...
    public Dimension render(Graphics2D graphics) {
        ...
        LinkedHashMultimap<ZulrahType, MutablePair<String, Boolean>> zulrahPhases = LinkedHashMultimap
                .create();
    ...
    private InfoBoxComponent infoBoxComponent(
        ...
        infoBox.setColor(!entry.getValue().getRight() ? Color.GREEN : Color.RED);
    ...
    private void displayRotationName(Graphics2D graphics) {
        ...
        String text = plugin.getCurrentRotation() != null ? plugin.getCurrentRotation().getRotationName()
                : "Unidentified";
