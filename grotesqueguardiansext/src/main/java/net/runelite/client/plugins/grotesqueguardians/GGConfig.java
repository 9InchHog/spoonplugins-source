...
public interface GGConfig extends Config {
    ...
    @ConfigSection(
            name = "Tick Counters",
            description = "Configuration for tick counters",
            position = 1,
            closedByDefault = true
    )
    ...
    @ConfigSection(
            name = "Utilities",
            description = "Utilities to assist during the fight",
            position = 2,
            closedByDefault = true
    )
    ...
    @ConfigItem(
            ...
            description = "Highlights the AoE in a 3x3 for the options below",
            position = 3,
            section = highlightSections
    )
    ...
    @ConfigItem(
            ...
            description = "Highlights the lightning that spawns",
            position = 4,
            section = highlightSections
    )
    ...
    @ConfigItem(
            ...
            description = "Configures the color of marked lightning",
            position = 5,
            section = highlightSections
    )
    ...
    @ConfigItem(
            ...
            description = "Highlights the falling rocks that spawns",
            position = 6,
            section = highlightSections
    )
    ...
    @ConfigItem(
            ...
            description = "Configures the color of marked falling rocks",
            position = 7,
            section = highlightSections
    )
    ...
    @ConfigItem(
            name = "Highlight Dawns Stone Orb",
            keyName = "highlightStoneOrbs",
            description = "Highlights the stone orb that Dawn throws",
            position = 8,
            section = highlightSections
    )
    ...
    @Alpha
    @ConfigItem(
            name = "Stone Orb Color",
            keyName = "stoneOrbColor",
            description = "Configures the color of the marked stone orb",
            position = 9,
            section = highlightSections
    )
    ...
    @ConfigItem(
            name = "Dawn Attack Tick Counter",
            keyName = "dawnTickCounter",
            description = "Displays when Dawn can attack and her transition times",
            position = 10,
            section = tickCounterSections
    )
    ...
    @ConfigItem(
            name = "Dusk Attack Tick Counter",
            keyName = "duskTickCounter",
            description = "Displays when Dusk can attack and his transition times",
            position = 11,
            section = tickCounterSections
    )
    ...
    @ConfigItem(
            name = "Healing Orb Tick Counter",
            keyName = "healingOrbTickCounter",
            description = "Displays when Dawn will heal off her orbs",
            position = 12,
            section = tickCounterSections
    )
    ...
    @ConfigItem(
            name = "Step Back Warning",
            keyName = "stepBackWarning",
            description = "Displays to when to step back during dusk glowing wing attack",
            position = 13,
    ...
    @ConfigItem(
            ...
            description = "Displays what to pray during phase 4",
            position = 14,
            section = utilitySection
    )
    ...
    @ConfigItem(
            name = "Dusk Overlay",
            keyName = "duskOverlay",
            description = "Overlay on dusk with a color denoting whether its attackable or transitioning",
            position = 15,
            section = utilitySection
    )
    ...
    @ConfigItem(
            name = "Dawn Overlay",
            keyName = "dawnOverlay",
            description = "Overlay on dawn with a color denoting whether its attackable or transitioning",
            position = 16,
            section = utilitySection
    )
    ...
    @ConfigItem(
            name = "Splits",
            keyName = "splits",
            description = "Splits timer for each phase during the fight",
            position = 17,
            section = utilitySection
    )
