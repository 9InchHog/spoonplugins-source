...
class XpInfoBox extends JPanel {
    ...
    XpInfoBox(RaidsPointsPlugin raidsPlugin, RaidsPointsConfig raidsConfig, Client client, JPanel panel, data raid, SkillIconManager iconManager) throws IOException {
        ...
        this.statsPanel.setLayout((LayoutManager)new DynamicGridLayout(3, 2));
        ...
        this.statsPanel.add(this.totalPoints);
        this.statsPanel.add(this.hourlyPoints);
        this.statsPanel.add(this.teamHour);
        ...
        if (raid.cm) {
            ...
            this.layout.setText("<html><p>Regular</p></html>");
        }
    ...
    static String htmlLabel(String key, String value) {
        return String.format("<html><body style='color:%s'>%s<span style='color:white'>%s</span></body></html>", ColorUtil.toHexColor(ColorScheme.LIGHT_GRAY_COLOR), key, value);
    }
