...
public class PoisonWeaponMap
{
    ...
    static
    {
        ...
        PoisonType.put(ItemID.PHARAOHS_SCEPTRE_1, PoisonStyle.NOT);
        PoisonType.put(ItemID.PHARAOHS_SCEPTRE_2, PoisonStyle.NOT);
        PoisonType.put(ItemID.PHARAOHS_SCEPTRE_3, PoisonStyle.NOT);
        PoisonType.put(ItemID.PHARAOHS_SCEPTRE_4, PoisonStyle.NOT);
        PoisonType.put(ItemID.PHARAOHS_SCEPTRE_5, PoisonStyle.NOT);
        PoisonType.put(ItemID.PHARAOHS_SCEPTRE_6, PoisonStyle.NOT);
        PoisonType.put(ItemID.PHARAOHS_SCEPTRE_7, PoisonStyle.NOT);
        PoisonType.put(ItemID.PHARAOHS_SCEPTRE_8, PoisonStyle.NOT);
